    ...
    return [
        ...
        'i18n' => [
            'page' => [
                ...
                'themeToggleTitle' => __('Toggle light and dark theme', 'darktech-price-editor'),
                'themeSwitchToDark' => __('Switch to dark theme', 'darktech-price-editor'),
                'themeSwitchToLight' => __('Switch to light theme', 'darktech-price-editor'),
                'themeSystemHint' => __('System theme is used by default until you switch manually.', 'darktech-price-editor'),
